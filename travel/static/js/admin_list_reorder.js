django.jQuery(document).ready(function() {
    ...
    django.jQuery('.grp-changelist-results tbody').sortable({
        ...
        update: function(event, ui) {
            ...
            // Update row classes
            django.jQuery(this).find('tr').removeClass('grp-row-even').removeClass('grp-row-odd');
            django.jQuery(this).find('tr:even').addClass('grp-row-even');
            django.jQuery(this).find('tr:odd').addClass('grp-row-odd');
        }
    });
});